...
const Hero = () => {
  return (
    <header className="flex mt-[5rem] md:mt-0 md:h-screen w-full flex-col items-center justify-center gap-4">
      <motion.div
      ...
      <div className="flex w-full flex-col md:mt-[5rem] md:w-3/4 md:flex-row md:items-center md:gap-5">
        ...
        className="flex w-3/4 flex-col gap-5">
          ...
          <p className="paraHover">
            She patiently waited for his number to be called. She had no desire
            to be there, but her mom had insisted that she go. She&#39;s
            resisted at first, but over time she realized it was simply easier
            to appease her and go. Mom tended to be that way. She would keep
            insisting until you wore down and did what she wanted. So, here she
            sat, patiently waiting for her number to be called.
          </p>
          <button type="button" className="btn w-1/2 btn-read-more">
            Read More
          </button>
        </motion.div>
      </div>
